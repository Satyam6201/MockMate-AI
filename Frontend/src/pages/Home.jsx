      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='flex justify-center mb-10'>
            <div className='bg-gray-100 text-gray-600 text-sm px-5 py-2 rounded-full flex items-center gap-2'>
          ...
          <div className='text-center mb-28'>
            <motion.h1 
              ...
              <span className='inline-block ml-2 bg-green-100 text-green-600 px-5 py-1 rounded-full'>
                AI Intelligence
              </span>
            </motion.h1>
          ...
          <div className='flex flex-col md:flex-col justify-center items-center gap-10 mb-28'>
            {
              [
                {
                  ...
                  desc: "AI adjusts difficult based on selected job role"                
                },
                {
                  icon: <BsMic size={24} />,
                  step: "STEP 2",
                  ...
                  <motion.div key={index} 
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      <div className='w-full md:w-1/2 flex justify-center'>
                        <img className='w-full h-auto object-contain max-h-64' 
                      ...
                      <div className='w-full md:w-1/2'>
                        ...
                        <h3 className='font-semibold mb-3 text-xl'>{items.title}</h3>
